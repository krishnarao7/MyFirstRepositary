...
public class ATMSimulator {
	...
	{
		Account myAccount= new Account(12341234,"Tony",100000);
		...
		Dispenser dispenser=new Dispenser(10000,myAtm.getCash());
		Dispenser dispenser2=new Dispenser(50000,myAtm.getCash());
